...
if (isset($_POST['submit'])) {
    ...
    $pin = $_POST['pin'];
    $amount = $_POST['amount'];
    $date = date('d l M') . " and time " . date("h:i:sA");
...
?>
        ...
        if ($password === $cpassword) {
            ...
            if ($insert_query) {
                $subject = "Email activation for state bank of india";
                $body = "Hii,$fullname please click the below link to activate your account 
