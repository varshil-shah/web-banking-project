...
<body>
        ...
        <section class="about" id="about">
                <div class="container-fluid">
                        <h2 class="text-center font-weight-bold py-5"><span class="text-danger">About</span><span
                                        class="text-warning"> Us</span></h2>
                </div>
                        ...
                        <div class="row">
                                <div class="col-lg-4 col-md-4 mb-5 col-12">
                                        <div class="card w-100 shadow" style="width: 18rem;">
                                                <img class="card-img-top" src="images/transaction.jpg"
                                                        alt="Card image cap">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-4 mb-5 col-12">
                                        <div class="card w-100 shadow" style="width: 18rem;">
                                                <img class="card-img-top" src="images/debitcard.jpg"
                                                        alt="Card image cap">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-4 mb-5 col-12">
                                        <div class="card w-100 shadow" style="width: 18rem;">
                                                <img class="card-img-top" src="images/online-banking.jpg"
                                                        alt="Card image cap">
                                                <div class="card-body">
                                ...
                                <div class="col-lg-4 col-md-4 mb-5 col-12">
                                        <div class="card w-100 shadow" style="width: 18rem;">
                                                <img class="card-img-top" src="images/cash-back.jpg"
                                                        alt="Card image cap">
                                                <div class="card-body">
        ...
        <section class="login" id="login">
                <div class="container-fluid">
                        <h2 class="text-center font-weight-bold py-5"><span class="text-success">Login</span><span
                                        class="text-warning"> Page</span></h2>
                </div>
                                ...
                                <div class="col-lg-6 offset-lg-1 col-md-6 col-12">
                                        <div class="formBx">
                                                <form action="login.php" method="POST" class="mt-4">
                                                        <input required type="email" type="email" name="loginemail"
                                                                placeholder="Enter your email address">
                                                        <input required type="password" type="password"
                                                                name="loginpassword"
                                                                placeholder="Enter your password here">
                                                        <div class="col-1 mb-3 mr-5">
                                                                <button class="btn btn-primary" name="login"
                                                                        type="submit">Login</button>
                                                        </div>
                                                        <p>Don't have an account <a href="registration.php">Click
                                                                        here</a></p>
                                                </form>
                                        </div>
                                </div>
